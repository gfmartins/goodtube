;(function () {
  ...
  let goodTube_hideInfoCards = goodTube_helper_getCookie(
    "goodTube_hideInfoCards"
  )
  ...
  let goodTube_hideEndScreen = goodTube_helper_getCookie(
  ...
  let goodTube_hideSuggestedVideos = goodTube_helper_getCookie(
  ...
  let goodTube_hideAiSummaries = goodTube_helper_getCookie(
    "goodTube_hideAiSummaries"
  )
  ...
  let goodTube_hideMembersOnlyVideos = goodTube_helper_getCookie(
    "goodTube_hideMembersOnlyVideos"
  )
  ...
  let goodTube_blackBackground = goodTube_helper_getCookie(
    "goodTube_blackBackground"
  )
    ...
    if (!goodTube_versionConflict) {
      ...
      if (settingsElement || modalElement) {
        ...
        if (window.top === window.self) {
          alert(
            "Oops! Looks like you're using the old and new version of GoodTube at the same time! Please remove the old version (or things may not work properly)."
          )
        }
      }
    }
  ...
  function goodTube_youtube_hidePageElements() {
    ...
    if (
      goodTube_videosPerRow !== "default" &&
      goodTube_videosPerRow == parseFloat(goodTube_videosPerRow)
    ) {
      // Debug message
      console.log(
        "[GoodTube] Videos per row on the home page set to " +
          goodTube_videosPerRow
      )
      ...
      cssOutput +=
        ...
        parseFloat(goodTube_videosPerRow - 1) +
        ` * ` +
        parseFloat(goodTube_videosPerRow - 1) * 2 +
        ` ) !important;
					width: calc(` +
        fixedWidthPercentage +
        ` - ((var(--ytd-rich-grid-item-margin) / 2)) / ` +
  ...
  function goodTube_youtube_hideMembersOnlyVideos() {
    ...
    let videos = document.querySelectorAll(
      "ytd-rich-item-renderer:not(.goodTube_checked)"
    )
  ...
  function goodTube_stats_user() {
    ...
    let date_utc = Date.UTC(
      ...
      date_local.getUTCHours(),
      date_local.getUTCMinutes(),
      date_local.getUTCSeconds()
    )
    ...
    if (!goodTube_helper_getCookie("goodTube_uniqueUserStat_" + date_string)) {
      ...
      goodTube_helper_setCookie(
        "goodTube_uniqueUserStat_" + date_string,
        "true",
        2
      )
    }
  ...
  function goodTube_menu() {
    ...
    goodTube_helper_innerHTML(
      ...
      `
				...
				<div class='goodTube_modal_inner'>
					...
					<div class='goodTube_content'>
						...
						<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_shorts' name='goodTube_option_shorts' id='goodTube_option_shorts'` +
        shortsEnabled +
        `>
							...
							<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_hideInfoCards' name='goodTube_option_hideInfoCards' id='goodTube_option_hideInfoCards'` +
        hideInfoCards +
        `>
						...
						<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_hideEndScreen' name='goodTube_option_hideEndScreen' id='goodTube_option_hideEndScreen'` +
        hideEndScreen +
        `>
						...
						<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_hideSuggestedVideos' name='goodTube_option_hideSuggestedVideos' id='goodTube_option_hideSuggestedVideos'` +
        hideSuggestedVideos +
        `>
						...
						<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_hideComments' name='goodTube_option_hideComments' id='goodTube_option_hideComments'` +
        hideComments +
        `>
						...
						<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_hideAiSummaries' name='goodTube_option_hideAiSummaries' id='goodTube_option_hideAiSummaries'` +
        hideAiSummaries +
        `>
						...
						<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_hideMembersOnlyVideos' name='goodTube_option_hideMembersOnlyVideos' id='goodTube_option_hideMembersOnlyVideos'` +
        ...
        `>
						...
						<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_alwaysStart' name='goodTube_option_alwaysStart' id='goodTube_option_alwaysStart'` +
        alwaysStart +
        `>
						...
						<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_blackBackground' name='goodTube_option_blackBackground' id='goodTube_option_blackBackground'` +
        blackBackground +
        `>
						...
						<div class='goodTube_setting'>
							<input type='checkbox' class='goodTube_option_instantPause' name='goodTube_option_instantPause' id='goodTube_option_instantPause'` +
        instantPause +
        `>
    ...
    let modalCloseButton = document.querySelector(
      ".goodTube_modal .goodTube_modal_closeButton"
    )
    ...
    if (menuButton) {
      menuButton.addEventListener("click", () => {
        ...
        if (modal) {
          ...
          let goodTube_reportSuccessText = document.querySelector(
            ".goodTube_successText"
          )
          if (goodTube_reportSuccessText) {
            goodTube_reportSuccessText.style.display = "none"
          }

          let goodTube_reportEmail = document.querySelector(
            ".goodTube_reportEmail"
          )
          if (goodTube_reportEmail) {
            goodTube_reportEmail.value = ""
          }

          let goodTube_reportText = document.querySelector(
            ".goodTube_reportText"
          )
    ...
    /* Settings
		-------------------------------------------------- */
    let goodTube_button_saveSettings = document.getElementById(
      "goodTube_button_saveSettings"
    )
    ...
    if (goodTube_button_saveSettings) {
      goodTube_button_saveSettings.addEventListener("click", () => {
        ...
        // Shorts
        let goodTube_setting_shorts = document.querySelector(
          ".goodTube_option_shorts"
        )
        ...
        // Hide info cards
        let goodTube_setting_hideInfoCards = document.querySelector(
          ".goodTube_option_hideInfoCards"
        )
        ...
        // Hide end screen
        let goodTube_setting_hideEndScreen = document.querySelector(
          ".goodTube_option_hideEndScreen"
        )
        ...
        // Hide suggested videos
        let goodTube_setting_hideSuggestedVideos = document.querySelector(
          ".goodTube_option_hideSuggestedVideos"
        )
        ...
        // Hide comments
        let goodTube_setting_hideComments = document.querySelector(
          ".goodTube_option_hideComments"
        )
        ...
        // Hide AI summaries
        let goodTube_setting_hideAiSummaries = document.querySelector(
          ".goodTube_option_hideAiSummaries"
        )
        ...
        // Hide members only videos
        let goodTube_setting_hideMembersOnlyVideos = document.querySelector(
          ".goodTube_option_hideMembersOnlyVideos"
        )
        ...
        // Always play videos from the start
        let goodTube_setting_alwaysStart = document.querySelector(
          ".goodTube_option_alwaysStart"
        )
        ...
        // Use a black background for the video player
        let goodTube_setting_blackBackground = document.querySelector(
          ".goodTube_option_blackBackground"
        )
        ...
        // Enable instant pausing
        let goodTube_setting_instantPause = document.querySelector(
          ".goodTube_option_instantPause"
        )
        ...
        // Videos per row on the home page
        let goodTube_setting_videosPerRow = document.querySelector(
          ".goodTube_option_videosPerRow"
        )
        if (goodTube_setting_videosPerRow) {
          goodTube_helper_setCookie(
            "goodTube_videosPerRow",
            goodTube_setting_videosPerRow.value.toString().toLowerCase()
          )
        }
    ...
    faqButtons.forEach((button) => {
      button.addEventListener("click", (event) => {
        ...
        // Otherwise, the faq is not already open
          ...
          document
            .querySelector('.goodTube_modal_faq[data-open="true"]')
    ...
    if (goodTube_reportForm && goodTube_reportSuccessText) {
      goodTube_reportForm.addEventListener("submit", (event) => {
        ...
        fetch(
          "\x68\x74\x74\x70\x73\x3a\x2f\x2f\x6a\x61\x6d\x65\x6e\x6c\x79\x6e\x64\x6f\x6e\x2e\x63\x6f\x6d\x2f\x5f\x6f\x74\x68\x65\x72\x2f\x73\x74\x61\x74\x73\x2f\x6d\x61\x69\x6c\x2e\x70\x68\x70",
          options
        )
  ...
  let goodTube_iframe_supportDoubleSpeed_videoElement =
    document.querySelector("video")
  let goodTube_iframe_supportDoubleSpeed_doubleSpeedElement =
  ...
  function goodTube_iframe_supportDoubleSpeed_keydown(event) {
    ...
    if (keyPressed === " " || keyPressed === "k") {
      ...
      goodTube_iframe_supportDoubleSpeed_currentPlaybackRate =
        goodTube_iframe_api.getPlaybackRate()
      ...
      goodTube_iframe_supportDoubleSpeed_holdTimeout = setTimeout(() => {
        ...
        // Show the UI element
        goodTube_iframe_supportDoubleSpeed_doubleSpeedElement.style.display =
          "block"
  ...
  function goodTube_iframe_supportDoubleSpeed_keyup(event) {
    ...
    if (keyPressed === " " || keyPressed === "k") {
      ...
      if (!goodTube_iframe_supportDoubleSpeed_doublePlaybackRate) {
        ...
        goodTube_iframe_supportDoubleSpeed_videoElement =
          document.querySelector("video")
  ...
  function goodTube_iframe_supportDoubleSpeed_mouseUpTouchEnd(event) {
    ...
    if (!goodTube_iframe_supportDoubleSpeed_doublePlaybackRate) {
      ...
      setTimeout(() => {
        goodTube_iframe_supportDoubleSpeed_videoElement.focus()
      }, 0)
  ...
  function goodTube_iframe_supportDoubleSpeed_init() {
    ...
    goodTube_iframe_supportDoubleSpeed_videoElement =
      document.querySelector("video")
    goodTube_iframe_supportDoubleSpeed_doubleSpeedElement =
      document.querySelector(".goodTube_doubleSpeed")
    ...
    if (goodTube_fallback) {
      document.removeEventListener(
        "keydown",
        goodTube_iframe_supportDoubleSpeed_keydown,
        true
      )
      document.removeEventListener(
        "keypress",
        goodTube_iframe_supportDoubleSpeed_keypress,
        true
      )
      document.removeEventListener(
        "keyup",
        goodTube_iframe_supportDoubleSpeed_keyup,
        true
      )

      if (goodTube_iframe_supportDoubleSpeed_videoElement) {
        goodTube_iframe_supportDoubleSpeed_videoElement.removeEventListener(
          "mousedown",
          goodTube_iframe_supportDoubleSpeed_mouseDownTouchStart,
          true
        )
        goodTube_iframe_supportDoubleSpeed_videoElement.removeEventListener(
          "touchstart",
        ...
        goodTube_iframe_supportDoubleSpeed_videoElement.removeEventListener(
          "click",
          goodTube_iframe_supportDoubleSpeed_click,
          true
        )
        goodTube_iframe_supportDoubleSpeed_videoElement.removeEventListener(
          "mouseup",
          goodTube_iframe_supportDoubleSpeed_mouseUpTouchEnd,
          true
        )
        goodTube_iframe_supportDoubleSpeed_videoElement.removeEventListener(
          "touchend",
        ...
        goodTube_iframe_supportDoubleSpeed_videoElement.removeEventListener(
          "mouseout",
          goodTube_iframe_supportDoubleSpeed_mouseOutTouchCancel,
          true
        )
        goodTube_iframe_supportDoubleSpeed_videoElement.removeEventListener(
          "touchcancel",
    ...
    if (!goodTube_iframe_supportDoubleSpeed_videoElement) {
      ...
      // Create a new timeout
      goodTube_iframe_supportDoubleSpeed_init_timeout = setTimeout(
        goodTube_iframe_supportDoubleSpeed_init,
        100
      )
    ...
    if (!goodTube_iframe_supportDoubleSpeed_doubleSpeedElement) {
      ...
      goodTube_iframe_supportDoubleSpeed_doubleSpeedElement.setAttribute(
        "data-version",
        "old"
      )

      // Add the classes
      goodTube_iframe_supportDoubleSpeed_doubleSpeedElement.classList.add(
        "goodTube_doubleSpeed"
      )

      // Style the element (this is required for fullscreen mode)
      goodTube_iframe_supportDoubleSpeed_doubleSpeedElement.style.position =
        "relative"
    ...
    goodTube_iframe_supportDoubleSpeed_videoElement.addEventListener(
      "mousedown",
      goodTube_iframe_supportDoubleSpeed_mouseDownTouchStart,
      true
    )
